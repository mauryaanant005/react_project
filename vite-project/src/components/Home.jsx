...
import fash_icon from 'H:/React Project/Project/vite-project/src/assets/fashion1.png'
import wear from 'H:/React Project/Project/vite-project/src/assets/icon1.jpg'
import furn from 'H:/React Project/Project/vite-project/src/assets/furn1.png'
import Navbar from './Navbar.jsx'
import {useNavigate} from 'react-router-dom'
import iphone1 from 'H:/React Project/Project/vite-project/src/assets/iphon1.jpg'
import fresh from 'H:/React Project/Project/vite-project/src/assets/fresh.png'
import TV from 'H:/React Project/Project/vite-project/src/assets/TV.png'


import  'H:/React Project/Project/vite-project/src/components/Home.css'
...
const Home = () => {
  ...
  const images = [
    {
      src: 'https://m.media-amazon.com/images/G/31/IMG24/Smart_Watches/June_SW/978x900_BS3._CB553778125_.gif',
      link: '/Wearables',
    },
    {
      src: 'https://m.media-amazon.com/images/I/81rNai7AVUL._AC_UL480_FMwebp_QL65_.jpg',
      link: '/Furniture',
    },
    {
      src: 'https://m.media-amazon.com/images/G/31/img21/MA2024/SS24flip/BBD/Casual_Shirts_978x1410._SX846_QL85_FMpng_.png',
      link: '/Fashion',
    },
    {
      src: 'https://m.media-amazon.com/images/S/al-eu-726f4d26-7fdb/bbb9b9b5-7f32-4537-a994-66f176574a16._CR0,0,1200,628_SX810_QL70_.jpg',
      link: '/Smartdevice',
    },
    {
      src: 'https://m.media-amazon.com/images/I/51vV9nPUo7L.AC_SR180,120_QL70.jpg',
      link: '/product/5',
    },
  ];
...
const navigate=useNavigate()
  ...
  <div className="categories">
    <div className="category">
      <img src={TV} className="icon" alt="Tv & Appliances"/>
      <h1 id="header" ><a className="anc" href="/Tv&Appliance">Tv & Appliances</a></h1>
    </div>
    <div className="category">
      <img src={fash_icon} className="icon" alt="Fashion"/>
      <h1 id="header"  ><a className="anc" href="/Fashion">Fashion</a></h1>
    </div>
    <div className="category">
      <img src={'https://rukminim2.flixcart.com/flap/80/80/image/22fddf3c7da4c4f4.png?q=100'} className="icon" alt="Tablets & Mobile"/>
      <h1 id="header"  ><a className="anc" href="/Smartdevice">Mobiles & Tablets</a></h1>
    </div>
    <div className="category">
      <img src={wear} className="icon" />
      <h1 id="header" ><a className="anc" href="/Wearables">Wearables</a></h1>
    </div>
    <div className="category">
      <img src={furn} className="icon" alt="Furniture"/>
     <h1 id="header" ><a className="anc" href="/Furniture">Furniture</a></h1>
    </div>
    <div className="category">
      <img src={fresh} className="icon" alt="Furniture"/>
     <h1 id="header" ><a className="anc" href="/Fresh">Vegetables & Fruits</a></h1>
    </div>
   </div>
   </div>
